 ...
 */
export const content = `<p><span data-lab-italic="italic" class="italic m-italic">Leijonan luola Suomi -</span>sijoittajat pääsevät 9.10. nähtävässä jaksossa urheilemaan, kun ohjelmassa haetaan 50 000 euron sijoitusta seinäkiipeilylaitteita valmistavalle yritykselle.</p><div style="position:relative;overflow:hidden;padding-bottom:56.25%"><iframe src="https://videot.seiska.fi/players/BtZhHEW7-wRrEuXAq.html" width="100%" height="100%" frameborder="0" scrolling="auto" title="PMMP sai karaokebaarin sekaisin" style="position:absolute;" allowfullscreen></iframe></div><p>Suunnittelija ja yrittäjä <span data-lab-font_weight="font-weight-bold" class="font-weight-bold m-font-weight-bold">Kaarle Vanamo</span> esittelee Climbstationin ja kertoo, kuinka laite reagoi seinäkiipeilijän omaan vauhtiin ja kiipeilyseinä rullaa sen mukaan. Laite herättää leijonien kiinnostuksen.</p><p> – Saisiko joku leijona testata tätä? <span data-lab-font_weight="font-weight-bold" class="font-weight-bold m-font-weight-bold">Jenni Kynnös </span>innostuu.</p><p>Lopulta Jari Sarasvuo päätyy testaamaan kiipeilytaitojaan. Seuraa kiroilua, kohellusta ja naurua, kun liikkuva seinä tuottaa sijoittajalle haasteita.</p><p> – Nämä ei ole varsinaisesti kiipeilykengät, Jari mutisee.</p><p><span class="article-link"> <a href="https://www.seiska.fi/katso/ensitreffit-alttarilla-matin-taustoista-paljastui-yllattava-seikka-haki-apua-huonoihin-elintapoihinsa/1158550"><strong>Ensitreffit alttarilla -Matin taustoista paljastui yllättävä seikka – haki apua huonoihin elintapoihinsa</strong></a> </span><br></p><figure class="pp-media"><img class="pp-media__image" alt="" src="https://image.seiska.fi/undefined.jpg?width=710&"><figcaption class="pp-media__caption"></figcaption></figure><p>Vaikka kiipeäminen itsessään ei sujunut täysin mallikkaasti, Jari kehuu hetkeä hauskaksi. </p><p> – Mulla oli kivaa! Jari julistaa huteran yrityksensä päätteeksi.</p><p>Seuraavaksi Wolt-perustajana tunnettu <span data-lab-font_weight="font-weight-bold" class="font-weight-bold m-font-weight-bold">Elias Aalto</span> näyttää leijonille, kuinka kiivetään tyylillä. Sijoittajat ällistelevät, kun Elias saa vaivatta kiipeilyseinän rullaamaan vauhdilla.</p><p> – Jari, tuolta tuntuu nöyryytys! <span data-lab-font_weight="font-weight-bold" class="font-weight-bold m-font-weight-bold">Kim Väisänen </span>toteaa.<br></p><p> – Nii-in, Jari sanoo saaden muut leijonat nauramaan.</p><p> <span data-lab-italic="italic" class="italic m-italic">Leijonan luola Suomi maanantaisin Nelosella ja Ruudussa.</span></p>`;
...
export const article = {
  ...
  field: {
    ...
    visibility_status: "P",
    viewports_json: "[]",
    used_image_ids_json: "[1136175,1158320,1145783,1158699]",
    ...
    published_url:
      "/katso/jari-sarasvuo-haviaa-nayttavasti-leijonan-luolassa-wolt-perustajalle-tuolta-tuntuu-noyryytys/1158659",
    published: "1696859027",
    page_template_alias: "katso_article",
    lockUser: "25",
    lockTime: "1696858993",
    lockSessionId: "5cf20b45-155b-4a4d-97ea-1521fcf6b4a8",
    modified: "1696859044",
  },
  primarytag: {
    "@attributes": {
  ...
  children: {
      ...
      children: {
        ...
        image: {
          ...
          field: {
            ...
            caption: {},
            viewports_json: "[]",
            name: "leijonan_luola_kausi_1_jakso_5_jenni_kynnos_jari_sarasvuo_1_kuvaaja_atte_malaska_05.jpg",
          },
        },
      },
    },
    articleList: {
      ...
      field: {
        ...
        title: "Saatat pitää myös näistä",
        viewports_json: "[]",
        instanceofprototypeid: "1068873",
      },
      children: {
        "@attributes": {
          type: "node",
        ...
        article: [
          {
            ...
            field: {
              ...
              subtitle:
                "Selviytyjät Suomesta pudonnut juontaja Gogi Mavromichalis kertoo loukanneensa itsensä jo pelin alussa, mutta ei kertonut siitä kilpakumppaneilleen.",
              viewports_json: "[]",
              title:
                "Gogi paljastaa loukkaantuneensa heti Selviytyjien alussa – salasi kovat kipunsa koko kisan ajan",
              site_id: "2",
              site_alias: "seiska",
              showcomments: {},
              section: "katso",
              published_url:
                "/katso/gogi-paljastaa-loukkaantuneensa-heti-selviytyjien-alussa-salasi-kovat-kipunsa-koko-kisan-ajan/1158292",
              published: "2023-10-09T10:09:18+02:00",
              kicker: {},
              cross_brand: "1",
              byline: "Anuliina Liukkonen",
            },
            tag: {
              "@attributes": {
                type: "property",
              ...
              tag: [
                "gogi mavromichalis",
                "selviytyjät suomi 2023",
                "alina voronkova",
                "selviytyjät suomi",
                "katso",
                "selviytyjät suomi kausi 7",
              ],
            },
            children: {
              "@attributes": {
          ...
          },
          {
            ...
            field: {
              ...
              title:
                "Stefan Lindforsin omituinen käytös suututti Elämäni biisin katsojat: ”Järkyttävää!”",
              section: "katso",
              published_url:
                "/katso/stefan-lindforsin-omituinen-kaytos-suututti-elamani-biisin-katsojat-jarkyttavaa/1158266",
              published: "2023-10-09T10:50:05+02:00",
              kicker: {},
              cross_brand: "1",
              byline: "Pekka Luokkala",
              viewports_json: "[]",
              subtitle:
                "Muotoilija Stefan Lindfors puhui muun muassa toisten päälle ja halusi kesken lähetyksen päästä vessaan Elämäni biisin suorassa lähetyksessä lauantaina 7.10.",
              site_id: "2",
              site_alias: "seiska",
              showcomments: {},
            },
          ...
          },
          {
            ...
            field: {
              ...
              section: "katso",
              published_url:
                "/katso/efter-nio-juontajat-provosoituvat-haastateltavan-elamantyylista/1158108",
              published: "2023-10-09T08:55:57+02:00",
              kicker: {},
              cross_brand: "1",
              byline: "Emmi Ikonen",
            },
            tag: {
              ...
              tag: ["efter nio", "janne grönroos", "eva kela", "katso"],
            },
            children: {
              "@attributes": {
                type: "node",
    ...
    //     markup: {},
    //     viewports_json:
    //       '{"desktop":{"fields":{"markup":"<div style=\\"width: 100%; height: 0; padding-bottom: 56.25%; position: relative;\\"><iframe id=\'embeddedCode_iframe\' name=\'embeddedCode_iframe\' allowfullscreen style=\'position: absolute; border-style: none; border-width: initial; border-color: initial; overflow-x: hidden; overflow-y: hidden; left: 0; top: 0; height: 100%; width: 100%;\' src=\'\\/\\/sf.nm-ovp.nelonenmedia.fi\\/player\\/misc\\/embed_player.html?nid=4423748\'><\\/iframe><\\/div>"}}}',
    //   },
    // },
    image: [
      {
